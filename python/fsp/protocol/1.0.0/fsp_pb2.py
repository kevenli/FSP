...
_sym_db.RegisterEnumDescriptor(_TASKSTATUSUPDATE_STATUS)
...
_sym_db.RegisterEnumDescriptor(_LOGINRESPONSE_LOGINRESULTTYPE)
...
_sym_db.RegisterEnumDescriptor(_REGISTERTASKRESPONSE_REGISTERTASKRESULTTYPE)
...
_sym_db.RegisterEnumDescriptor(_RESUMESESSIONRESPONSE_RESUMERESULTTYPE)
...
DESCRIPTOR.extensions_by_name['heartbeat'] = heartbeat
DESCRIPTOR.extensions_by_name['connect_request'] = connect_request
DESCRIPTOR.extensions_by_name['login_request'] = login_request
DESCRIPTOR.extensions_by_name['register_task'] = register_task
DESCRIPTOR.extensions_by_name['task_status_update'] = task_status_update
DESCRIPTOR.extensions_by_name['logout_request'] = logout_request
DESCRIPTOR.extensions_by_name['resume_session_request'] = resume_session_request
DESCRIPTOR.extensions_by_name['unregister_task'] = unregister_task
DESCRIPTOR.extensions_by_name['create_task'] = create_task
DESCRIPTOR.extensions_by_name['connect_response'] = connect_response
DESCRIPTOR.extensions_by_name['login_response'] = login_response
DESCRIPTOR.extensions_by_name['register_task_response'] = register_task_response
DESCRIPTOR.extensions_by_name['task_notify'] = task_notify
DESCRIPTOR.extensions_by_name['logout_response'] = logout_response
DESCRIPTOR.extensions_by_name['resume_session_response'] = resume_session_response
DESCRIPTOR.extensions_by_name['unregister_task_response'] = unregister_task_response
DESCRIPTOR.extensions_by_name['create_task_response'] = create_task_response
...
RegisterTask = _reflection.GeneratedProtocolMessageType('RegisterTask', (_message.Message,), dict(
  DESCRIPTOR = _REGISTERTASK,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:RegisterTask)
  ))
_sym_db.RegisterMessage(RegisterTask)

TaskStatusUpdate = _reflection.GeneratedProtocolMessageType('TaskStatusUpdate', (_message.Message,), dict(
  DESCRIPTOR = _TASKSTATUSUPDATE,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:TaskStatusUpdate)
  ))
_sym_db.RegisterMessage(TaskStatusUpdate)
...
ResumeSessionRequest = _reflection.GeneratedProtocolMessageType('ResumeSessionRequest', (_message.Message,), dict(
  DESCRIPTOR = _RESUMESESSIONREQUEST,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:ResumeSessionRequest)
  ))
_sym_db.RegisterMessage(ResumeSessionRequest)

UnregisterTask = _reflection.GeneratedProtocolMessageType('UnregisterTask', (_message.Message,), dict(
  DESCRIPTOR = _UNREGISTERTASK,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:UnregisterTask)
  ))
_sym_db.RegisterMessage(UnregisterTask)
...
RegisterTaskResponse = _reflection.GeneratedProtocolMessageType('RegisterTaskResponse', (_message.Message,), dict(
  DESCRIPTOR = _REGISTERTASKRESPONSE,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:RegisterTaskResponse)
  ))
_sym_db.RegisterMessage(RegisterTaskResponse)
...
ResumeSessionResponse = _reflection.GeneratedProtocolMessageType('ResumeSessionResponse', (_message.Message,), dict(
  DESCRIPTOR = _RESUMESESSIONRESPONSE,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:ResumeSessionResponse)
  ))
_sym_db.RegisterMessage(ResumeSessionResponse)

UnregisterTaskResponse = _reflection.GeneratedProtocolMessageType('UnregisterTaskResponse', (_message.Message,), dict(
  DESCRIPTOR = _UNREGISTERTASKRESPONSE,
  __module__ = 'fsp_pb2'
  # @@protoc_insertion_point(class_scope:UnregisterTaskResponse)
  ))
_sym_db.RegisterMessage(UnregisterTaskResponse)
